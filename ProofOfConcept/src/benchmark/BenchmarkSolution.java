...
public class BenchmarkSolution implements Solution{

	boolean[] sol;
	
	public BenchmarkSolution(boolean[] array) {
		this.sol = array;
	}
	...
	public boolean equals(Object o) {
        ...
        if (!(o instanceof BenchmarkSolution)) { 
            return false; 
        } 
          
        // typecast o so that we can compare data members  
        BenchmarkSolution c = (BenchmarkSolution) o; 
